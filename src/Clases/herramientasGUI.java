...
public class herramientasGUI {
        ...
        if (fc.showOpenDialog(null) == 0) {
            try {
                ...
                if(imagen.getWidth()!=1280 || imagen.getHeight()!=960){
                    imagen = toBufferedImage(imagen.getScaledInstance(1280, 960, Image.SCALE_DEFAULT));
                }
    ...
    private int comparaContrasena(String p1, String p2){
    ...
    public void contrasenasGUI(String p1, String p2, JButton boton, JLabel error, JLabel error2){
        int re = this.comparaContrasena(p1, p2);
        if(re==0){
